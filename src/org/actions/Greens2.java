...
public class Greens2 {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement kk = driver.findElement(By.xpath("(//div[@class='tonclickopen main-cat menu-item'])[3]"));
		Actions gg = new Actions(driver);
		gg.moveToElement(kk).perform();
		WebElement re = driver.findElement(By.xpath("//span[contains(text(),'Oracle DBA')]"));
		re.click();
	}
